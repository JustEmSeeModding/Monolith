...
public final class ModAdvancementProvider extends AdvancementProvider {
    ...
    private static AdvancementHolder createSimpleAdvancement(String location, String name, ItemStack icon, String criterionName, Criterion<?> criterion, AdvancementHolder parent, AdvancementType advancementType, boolean hidden, Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper) {
        ...
        return builder.save(saver, ResourceLocation.fromNamespaceAndPath(Monolith.MOD_ID, location + "/" + name), existingFileHelper);
    }
    ...
    private static AdvancementHolder createRootAdvancement(String location, ItemLike icon, ResourceLocation background, Map<String, Criterion> criterions, Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper) {
        ...
        return builder.save(saver, ResourceLocation.fromNamespaceAndPath(Monolith.MOD_ID, location + "/root"), existingFileHelper);
    }
